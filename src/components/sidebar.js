      ...
      <div className="w-screen h-screen flex flex-col fixed">
          <div style={{height: '60%'}} className="bg-black text-gray-50 font gotham">
              ...
              <div className="w-full flex items-center px-4 py-3">
                  <div className="w-14 h-14 rounded-full bg-gray-700 text-3xl font-light text-gray-50 flex items-center justify-center">
                      {username[0]}
                  </div>
                  <div className="ml-4">
                      <p>
              ...
              <div className="w-screen flex flex-col justify-start items-start">
                  ...
                  {is_authenticated ? (
                      <button
                          onClick={handleClick}
                          className="px-8 py-2 rounded-lg text-gray-50 font-gotham bg-blue-600 ml-4 mt-3">
                            Logout
                        </button>
                  ) : (
